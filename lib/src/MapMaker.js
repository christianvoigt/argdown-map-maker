      ...
      try {
        for (var _iterator = statementKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (this.settings.statementSelectionMode == "titled") {
            selectionTest = !equivalenceClass.isUsedAsPremise && !equivalenceClass.isUsedAsConclusion || !untitledTest.exec(equivalenceClass.title);
          } else if (this.settings.statementSelectionMode == "roots") {
            selectionTest = !equivalenceClass.isUsedAsPremise && !equivalenceClass.isUsedAsConclusion || equivalenceClass.isUsedAsRootOfStatementTree;
